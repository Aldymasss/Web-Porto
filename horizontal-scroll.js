...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let isPaused = false;
    let scrollSpeed = 0.8; // Pixels per frame - slower for smoother scrolling
    
    // Make sure the first slide is visible and scrolling starts from the right
    setTimeout(() => {
    ...
    function startAutoScroll() {
        ...
        // Initialize to start from rightmost position
        scrollContainer.scrollLeft = 0;
